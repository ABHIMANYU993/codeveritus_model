...
# # Example usage
# tokenizer = RobertaTokenizerFromScratch.load_pretrained('path_to_tokenizer')
# model = RobertaForSequenceClassificationFromScratch.load_pretrained('path_to_model')
